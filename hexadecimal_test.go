...
func Test_Is0xPrefixed_1(t *testing.T) {
...
func Test_Is0xPrefixed_2(t *testing.T) {
...
func Test_Is0xPrefixed_3(t *testing.T) {
	v := Is0xPrefixed("0Xe89943Ec20d856F064A87349a00Ef6aB00AED042")
	if v == false {
		t.Error("error")
	}
...
func Test_Add0xPrefix_1(t *testing.T) {
...
func Test_Add0xPrefix_2(t *testing.T) {
