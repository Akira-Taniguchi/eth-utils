...
func getEtherUnit(unit string) (decimal.Decimal, error) {
	...
	case "kwei":
		v, err = decimal.NewFromString("1000")
	case "babbage":
		v, err = decimal.NewFromString("1000")
	case "femtoether":
		v, err = decimal.NewFromString("1000")
	case "mwei":
		v, err = decimal.NewFromString("1000000")
	case "lovelace":
		v, err = decimal.NewFromString("1000000")
	case "picoether":
		v, err = decimal.NewFromString("1000000")
	case "gwei":
		v, err = decimal.NewFromString("1000000000")
	case "shannon":
		v, err = decimal.NewFromString("1000000000")
	case "nanoether":
		v, err = decimal.NewFromString("1000000000")
	case "nano":
		v, err = decimal.NewFromString("1000000000")
	case "szabo":
		v, err = decimal.NewFromString("1000000000000")
	case "microether":
		v, err = decimal.NewFromString("1000000000000")
	case "micro":
		v, err = decimal.NewFromString("1000000000000")
	case "finney":
		v, err = decimal.NewFromString("1000000000000000")
	case "milliether":
		v, err = decimal.NewFromString("1000000000000000")
	case "milli":
		v, err = decimal.NewFromString("1000000000000000")
	case "ether":
		v, err = decimal.NewFromString("1000000000000000000")
	case "kether":
		v, err = decimal.NewFromString("1000000000000000000000")
	case "grand":
		v, err = decimal.NewFromString("1000000000000000000000")
	case "mether":
		v, err = decimal.NewFromString("1000000000000000000000000")
	case "gether":
		v, err = decimal.NewFromString("1000000000000000000000000000")
	case "tether":
		v, err = decimal.NewFromString("1000000000000000000000000000000")
	default:
		{
